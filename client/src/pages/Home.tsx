 ...
 * or images without an explicit targeted request.
 *
 * Sections (in order):
 ...
 *   6. Final CTA
 *
 * Images: Each card has a unique CDN image. See CANVAS.md for URLs.
 * ============================================================
 *
 ...
 * Images: AI-generated champagne gold on near-black
 */
...
const REAL_ESTATE_IMG = "https://d2xsxph8kpxj0f.cloudfront.net/310519663496411445/2z4eQ63zZX7wyiYKot74mf/real-estate-card-BCqjSKjBPdPWBmC7zsNd8g.webp";
const CAR_IMG = "https://d2xsxph8kpxj0f.cloudfront.net/310519663496411445/2z4eQ63zZX7wyiYKot74mf/luxury-car-card-25nMJbHbHrGZbutZWvJnS3.webp";
const CRYPTO_GOLD_IMG = "https://d2xsxph8kpxj0f.cloudfront.net/310519663496411445/2z4eQ63zZX7wyiYKot74mf/crypto-gold-card-UWFJDeFD2gczSfuLsBqrLZ.webp";
const GOLD_IMG = "https://d2xsxph8kpxj0f.cloudfront.net/310519663496411445/2z4eQ63zZX7wyiYKot74mf/gold-card-Vz2Mdn8GXXAQUzSoHVwQ2m.webp";
...
const dealCategories = [
  ...
  {
    label: "Luxury Cars",
    description: "Private sales of exotic, collector, and high-value vehicles. Discreet transactions between qualified parties.",
    img: CAR_IMG,
    tag: "02",
  },
  {
  ...
  {
    label: "Gold",
    description: "Physical gold acquisitions and private sales. Verified, insured, and handled with full discretion.",
    img: GOLD_IMG,
    tag: "04",
  },
];
...
export default function Home() {
  ...
  return (
    <div className="bg-[oklch(0.10_0.005_60)]">
      {/* ─── HERO ─────────────────────────────────────────────── */}
      <section
      ...
      >
        ...
        <div className="relative z-10 container text-center flex flex-col items-center gap-6 pt-24 pb-20">
          ...
          {/* Sub-headline */}
          <p
            className="text-[oklch(0.72_0.12_75)] tracking-[0.18em] uppercase"
            style={{
          ...
          {/* Tagline */}
          <p
            className="text-[oklch(0.60_0.008_75)] max-w-lg leading-relaxed"
      ...
      <section className="py-28">
        <div className="container">
          <div className="max-w-4xl mx-auto">
            ...
            <h2
              className="reveal text-[oklch(0.93_0.012_75)] leading-tight mb-8"
              style={{
                fontFamily: "'Playfair Display', serif",
            ...
            >
              ...
              <em className="text-[oklch(0.72_0.12_75)]">high-value transactions</em>
            </h2>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {dealCategories.map((cat, i) => (
              <div
                key={cat.tag}
                className="reveal card-dark group overflow-hidden"
              ...
              >
                ...
                <div className="relative h-52 overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[oklch(0.10_0.005_60)/90] via-transparent to-transparent" />
                  <span
                    className="absolute top-3 left-3 text-[oklch(0.72_0.12_75)/40] font-bold"
                    style={{
                      fontFamily: "'Playfair Display', serif",
                      fontSize: "2.5rem",
                      lineHeight: 1,
                ...
                <div className="p-5">
                  <h3
                    className="text-[oklch(0.93_0.012_75)] mb-3"
                    style={{
                      fontFamily: "'Playfair Display', serif",
                      fontSize: "1.15rem",
                      fontWeight: 500,
        ...
        <div className="relative z-10 container">
          ...
          <div className="reveal mb-12 max-w-2xl">
            ...
            >
              ...
              <em className="text-[oklch(0.72_0.12_75)]">It is the foundation.</em>
            </h2>
          </div>
