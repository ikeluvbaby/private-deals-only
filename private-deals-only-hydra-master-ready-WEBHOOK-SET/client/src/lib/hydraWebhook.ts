...
export async function submitHydraLead(
  ...
  if (!HYDRA_WEBHOOK_URL || HYDRA_WEBHOOK_URL.includes("https://script.google.com/macros/s/AKfycbwyepybBUx39smY9wICC5i2vhl501fzGDlotGcHDek7Rd0lzUIHIq8bpW8tpM-5PGMZgQ/exec")) {
    throw new Error("Hydra webhook URL is not set in client/src/lib/hydraWebhook.ts");
  }
